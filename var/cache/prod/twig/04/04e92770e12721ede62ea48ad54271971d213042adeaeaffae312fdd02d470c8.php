...
(isset($context["origin"]) || array_key_exists("origin", $context))) ? (_twig_default_filter(($context["origin"] ?? null), "none")) : ("none"))]));
    ...
    {
        return new Source("", "@PrestaShop/Admin/Module/Includes/grid_notification_configure.html.twig", "C:\\xampp\\htdocs\\BabyBunns\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Module\\Includes\\grid_notification_configure.html.twig");
    }
}
